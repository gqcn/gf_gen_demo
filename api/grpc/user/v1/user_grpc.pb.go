...
func (c *userClient) SignIn(ctx context.Context, in *SignInReq, opts ...grpc.CallOption) (*SignRes, error) {
	out := new(SignRes)
	err := c.cc.Invoke(ctx, "/user.v1.User/SignIn", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Profile(ctx context.Context, in *ProfileReq, opts ...grpc.CallOption) (*ProfileRes, error) {
	out := new(ProfileRes)
	err := c.cc.Invoke(ctx, "/user.v1.User/Profile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _User_SignIn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.User/SignIn",
	}
...
func _User_Profile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.v1.User/Profile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
